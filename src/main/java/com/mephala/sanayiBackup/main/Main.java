        ...
        try {
            ...
            for (File subFile : subFiles) {
                ...
                if (subFile.isDirectory()) {
                    FileUtils.copyDirectory(subFile, new File(backupFolder + File.separator + backupFolderName + File.separator + subFile.getName()));
                } else {
                    FileUtils.copyFile(subFile, new File(backupFolder + File.separator + backupFolderName + File.separator + subFile.getName()));
                }
                if (subFile.isDirectory())
